...
export default function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" className="py-32 relative bg-slate-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          <div className="hidden lg:block absolute top-10 left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-200 to-transparent" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-4">
            {STEPS.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Icône monochrome bleu, carré arrondi */}
                  <div className="w-20 h-20 rounded-2xl border-2 border-brand-200 bg-brand-50 flex items-center justify-center mb-5 relative z-10">
                    <Icon className="w-8 h-8 text-brand-500" />
                  </div>
                  <h3 className="font-display font-600 text-slate-900 mb-2 text-sm">
